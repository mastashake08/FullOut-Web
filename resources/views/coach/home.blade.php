...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><a data-toggle="collapse" href="#menege-school">Manage School</a></div>
                <div id="menege-school" class="panel-collapse collapse">
                <div class="panel-body">
                    <div class="col-md-12 mb-2">
                        <a href="{{url('/coach/schools/'.auth()->user()->school->id)}}" class="btn btn-primary">View school public profile</a>
                    </div>
